-- Ensure family RLS policies are correctly set up for authenticated users
-- This migration ensures that authenticated users can create families during onboarding
